                ...
                <div className="home__content">
                    <div className="home__content-main">
                        <div className="home__new-post">
                            <textarea className="home__new-post-content" placeholder="What you have in your mind?" value={newPostText} onChange={(e) => setNewPostText(e.target.value)} />
                            { postImage[0] && <div className="home__new-post-image-container"><img className="home__new-post-image" src={postImage[0] && postImage[0].data_url} alt="post-img" /><span className="home__new-post-image-remove" onClick={() => setPostImage([])}><FontAwesomeIcon icon={faCircleXmark} /></span></div> }
                            <div className="home__new-post-footer">
                                ...
                                >
                                    ...
                                    dragProps
                                        ...
                                        <div className="home__new-post-upload" onClick={onImageUpload} {...dragProps}>
                                ...
                                <div className="home__to-follow-user">
                                    <div className="home__to-follow-user-detail">
                                        <span className="home__to-follow-user-thumbnail">
                                            <img className="home__to-follow-user-image" src="https://static.scientificamerican.com/sciam/cache/file/7A715AD8-449D-4B5A-ABA2C5D92D9B5A21_source.png" alt="user" />
                                        </span>
                                        <p className="home__to-follow-user-name">Sifat Dipta</p>
                                    </div>
                                    <Button text="Follow" type="primary" style={{ backgroundColor: "white", paddingLeft: "16px", paddingRight: "16px", color: "#725095" }} />
                                </div>
                                <div className="home__to-follow-user">
                                    <div className="home__to-follow-user-detail">
                                        <span className="home__to-follow-user-thumbnail">
                        ...
                        <div className="home__posts">
                            {
                                ...
                                posts.map(post => {
                                    return (
                                        <Post data={post} users={users} toast={toast} getPosts={getPosts} authUser={authUser} key={uuidv4()} />
                                    )
                                }) : ""
                            }
                        </div>
